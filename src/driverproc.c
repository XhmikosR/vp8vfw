 ...
 *	- driverproc main -
 *
 *  Original Copyright(C) 2001-2003 Peter Ross <pross@xvid.org> with Xvid 1.2.2
...
#define ICVERSION       0x0104
			...
			wcscpy(icinfo->szName, VP80_NAME_L); 
			wcscpy(icinfo->szDescription, VP80_DESC_L);
