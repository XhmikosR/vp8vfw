...
%define VP80_CPU_MMX      (1<< 0)
%define VP80_CPU_MMXEXT   (1<< 1)
%define VP80_CPU_SSE      (1<< 2)
%define VP80_CPU_SSE2     (1<< 3)
%define VP80_CPU_SSE3     (1<< 8)
%define VP80_CPU_SSE41    (1<< 9)
%define VP80_CPU_3DNOW    (1<< 4)
%define VP80_CPU_3DNOWEXT (1<< 5)
%define VP80_CPU_TSC      (1<< 6)
...
%define VP80_PUSHFD pushfq
%define VP80_POPFD  popfq
%else
%define VP80_PUSHFD pushfd
%define VP80_POPFD  popfd
%endif
...
check_cpu_features:
 ...
 ; RDTSC command ?
  CHECK_FEATURE CPUID_TSC, VP80_CPU_TSC, ebp, edx 

  ; MMX support ?
  CHECK_FEATURE CPUID_MMX, VP80_CPU_MMX, ebp, edx 

  ; SSE support ?
  CHECK_FEATURE CPUID_SSE, (VP80_CPU_MMXEXT|VP80_CPU_SSE), ebp, edx 

  ; SSE2 support?
  CHECK_FEATURE CPUID_SSE2, VP80_CPU_SSE2, ebp, edx 

  ; SSE3 support?
  CHECK_FEATURE CPUID_SSE3, VP80_CPU_SSE3, ebp, ecx 

  ; SSE41 support?
  CHECK_FEATURE CPUID_SSE41, VP80_CPU_SSE41, ebp, ecx 
 ...
 ; AMD cpu ?
  ...
  ; 3DNow! support ?
  CHECK_FEATURE EXT_CPUID_3DNOW, VP80_CPU_3DNOW, ebp, edx 

  ; 3DNOW extended ?
  CHECK_FEATURE EXT_CPUID_AMD_3DNOWEXT, VP80_CPU_3DNOWEXT, ebp, edx 

  ; extended MMX ?
  CHECK_FEATURE EXT_CPUID_AMD_MMXEXT, VP80_CPU_MMXEXT, ebp, edx 
